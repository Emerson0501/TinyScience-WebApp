...
export default function Sidebar() {
    ...
    return (
        <aside
            className={`min-h-screen text-white flex flex-col transition-all duration-300 ${isOpen ? "w-50" : "w-16"
                } bg-gradient-to-b from-[#FF70F0] via-[#FF867C] to-[#FF69B4] overflow-y-auto`}
        >
            ...
            <div className="flex-1 px-2 py-6 overflow-y-auto flex flex-col">
                ...
                <div className="mt-auto">
                    <Link
                        href="#"
                        className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-red-500 transition"
                    >
